function cargarVistaFRelatorio_Candidatos(itemID) {
    $$("views").addView({
        view: "tabview",
        id: itemID,
        height: 900,
                    ...
                    rows: [
                        {
                                    ...
                                    cols: [
                                        {
                                            view: "button", type: "standard", value: "Actualizar", width: 120, height: 50, click: function () {
                                                $$("idDTInscricao_Relatorios").clearAll();
                                                $$("idDTInscricao_Relatorios").load(BASE_URL + "CFinancas_Pagamentos_Candidatos/read");
                                            }
                                        },
                                        {}
                                    ]
                            ...
                            columns: [
                                ...
                                { id: "fpcData", header: ["Data", { content: "textFilter" }], width: 100, sort: "string" },
                                { id: "fpcHora", header: ["Hora", { content: "textFilter" }], width: 80, sort: "string" },
                                ...
                                { id: "contNome", header: ["Nome Conta", { content: "textFilter" }], width: 160, sort: "string" },
                                { id: "contNumero", header: ["N&uacute;mero Conta", { content: "textFilter" }], width: 110, sort: "string" },
                                { id: "ffpNome", header: ["Forma Pag.", { content: "textFilter" }], width: 90, sort: "string" },
                                { id: "fpcRefPagamento", header: ["Referência Pag.", { content: "textFilter" }], width: 120, sort: "strig" },
                                { id: "fpcValor", header: ["Valor (kz)", { content: "textFilter" }], width: 100, sort: "int" },
                            ],
                            url: BASE_URL + "CFinancas_Pagamentos_Candidatos/read",
                            pager: "pagerCDadosInscricao_Relatorios"
                        }, {
                            view: "pager", id: "pagerCDadosInscricao_Relatorios",
