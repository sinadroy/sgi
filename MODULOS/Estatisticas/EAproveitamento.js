//var codigo_foto;
function cargarVistaAproveitamento(itemID) {
    $$("views").addView({
        view: "tabview",
        id: itemID,
        //autoheight:true,
        ...
        cells: [
            {
                header: "Disciplinas Aproveitamento", body: {
                    rows: [
                        {
                            ...
                            rows: [
                                        ...
                                        },
                                        {
                                            ...
                                            on: {
                                                "onChange": function (newv, oldv) {
                                                    ...
                                                    if (n && c && p && ac) {
                                                        $$("id_CB_tNome_ap").getList().clearAll();
                                                        $$("id_CB_tNome_ap").getList().load(BASE_URL + "CTurmas/readXncp?nNome=" + n + "&cNome=" + c + "&pNome=" + p + "&ac=" + ac);
                                                    }
                                                }
                                            }
                                        },
                                    ...
                                    cols: [
                                        {
                                            ...
                                            on: {
                                                "onChange": function (newv, oldv) {
                                                    ...
                                                    if (n && c && p && ac && g) {
                                                        $$("id_cb_ap").setValue('');
                                                        $$("id_cb_ap").getList().clearAll();

                                                        $$("id_cb_ap").getList().load(BASE_URL + "CDisciplinas/readX_ac_n_c_p_g?nNome=" + n + "&cNome=" + c + "&pNome=" + p + "&acNome=" + ac + "&dgNome=" + g);
                                                    }
                                        ...
                                        {
                                            view: "richselect", width: 370, id: "id_cb_ap",
...

                                        {
                                            view: "button", type: "form", value: "Pesquisar", width: 110, click: function () {
                                                ...
                                                var p = $$("id_CB_pNome_ap").getValue();
                                                var ac = $$("id_CB_acNome_ap").getValue();
                                                var d = $$("id_cb_ap").getValue();
                                                var g = $$("id_cb_dgnome_ap").getValue();

                                                if (al && n && c && p && ac && d && g) {
                                                    $$("idDTaproveitamento").clearAll();
                                                    $$("idDTaproveitamento").load(BASE_URL + "cestatisticas/aproveitamento?n=" + n + "&c=" + c + "&p=" + p + "&al=" + al + "&d=" + d + "&al=" + al + "&g=" + g);
                                                    //activar exportar
                                ...
                                /*
                                {
                                    cols: [
                                        ...
                                        {
                                            view: "button", type: "form", value: "Imprimir", disabled: false, width: 120, click: function () {
                                                //criar PDF
                                                var nNome = $$("id_CB_nNome_ap").getValue();
                                                var cNome = $$("id_CB_cNome_ap").getValue();
                                                var pNome = $$("id_CB_pNome_ap").getValue();
                                                var ac = $$("id_CB_acNome_ap").getValue();
                                                var t = $$("id_CB_tNome_ap").getValue();
                                                var s = $$("id_CB_sNome_ap").getValue();
                                                ...
                                                if (nNome && cNome && pNome && ac && t) {
                                                    ...
                                                    if (r.responseText == "true") {
                                                        ...
                                                        webix.ui({
                                                            ...
                                                            body: {
                                                                //template:"Some text"
                                                                template: '<div id="idPDFap" style="width:690px;  height:590px"></div>'
                                                            }
                                                        }).show();
                                                        PDFObject.embed("../../relatorios/Listas_Gerais.pdf", "#idPDFap");
                                        ...
                                        
                                        {
                                            view: "button", type: "standard", value: "Actualizar", width: 120, click: function () {
                                                $$("idDTaproveitamento").clearAll();
                                                $$("idDTaproveitamento").load(BASE_URL + "CEstudantes/read");
                                            }
                                        },
                            ...
                            columns: [
                                ...
                                { id: "nome", header: "Nome", width: 200, sort: "string" },
                                { id: "valor", header: "Valor", width: 200, sort: "string" },
                            ],
                            resizeColumn: true,
                            url: BASE_URL + "cestatisticas/aproveitamento",
                            pager: "pagerAP"
                        }, {
                            view: "pager", id: "pagerAP",
