function cargarVistaDeclaracaoSemNotas(itemID) {
    var f = new Date();
                        ...
                        cols: [
                            {
                                view: "button", type: "form", value: "Imprimir", width: 100, click: function () {
                                    var idSelecionado = $$("idDTEdDeclaracaoSemNotas").getSelectedId(false, true);
                                    //cargar dados necesarios para enviar para imprimir
                                    var record = $$("idDTEdDeclaracaoSemNotas").getItem(idSelecionado);
                                    ...
                                    if (idSelecionado) {
                                        ...
                                        var r = webix.ajax().sync().post(BASE_URL + "Csecretaria_declaracao_sem_notas/imprimir", envio);
                                        if (r.responseText == "true") {
                                            ...
                                            PDFObject.embed("../../relatorios/secretaria_declaracao_sem_nota.pdf", "#idPDFDSN");

                                            $$("idDTEdDeclaracaoSemNotas").clearAll();
                                            $$("idDTEdDeclaracaoSemNotas").load(BASE_URL + "Cdocumentos_pendientes/read");
                            ...
                            url: BASE_URL + "Cdocumentos_pendientes/read",
                            pager: "pagerDocumentos_Pendientes"
                        }, {
                            view: "pager", id: "pagerDocumentos_Pendientes",
