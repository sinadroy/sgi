//var codigo_foto;
function cargarVistaListas_Disciplinas(itemID) {
    $$("views").addView({
        view: "tabview",
        id: itemID,
        //autoheight:true,
        ...
        cells: [
            {
                header: "Listas Disciplinas", body: {
                    rows: [
                        {
                                                    ...
                                                    on: {
                                                        "onChange": function (newv, oldv) {
                                                            ...
                                                            if (n) {
                                                                ...
                                                                $$("idLI_CB_cNome_ld").getList().load(BASE_URL + "Ccursos/readXn?nNome=" + this.getValue());
                                                            }

                                                            if (n && c && p && ac) {
                                                                $$("id_cb_ld_d").getList().clearAll();
                                                                $$("id_cb_ld_d").getList().load(BASE_URL + "CDisciplinas/readXancp?nNome=" + n + "&cNome=" + c + "&pNome=" + p + "&ac=" + ac);
                                                            }
                                                        }
                                                    }
                                                },
                                            ...
                                            cols: [
...

                                                {
                                                    view: "button", type: "form", value: "Perquisar", width: 110, click: function () {
                                                        ...
                                                        if (n && c && p && ac && d) {
                                                            $$("idDTInscricaoLD").clearAll();
                                                            $$("idDTInscricaoLD").load(BASE_URL + "CListas_Disciplinas/read_x_ncpacd?n=" + n + "&c=" + c +
                                                                "&p=" + p +
                                                                "&ac=" + ac +
                                                                "&d=" + d);
                                                        } else
                                    ...
                                    cols: [

                                        {
                                            view: "button", type: "standard", value: "Imprimir", disabled: false, width: 120, height: 50, click: function () {
                                                //criar PDF
                                                var nNome = $$("idLI_CB_nNome_ld").getValue();
                                                var cNome = $$("idLI_CB_cNome_ld").getValue();
                                                var pNome = $$("idLI_CB_pNome_ld").getValue();
                                                var ac = $$("idLI_CB_acNome_ld").getValue();
                                        ...
                                        {
                                            view: "button", type: "form", id: "idbtn_Exportar_DadosLG", value: "Exportar Dados", disabled: true, width: 120, height: 50, click: function () {
                            ...
                            resizeColumn: true,
                            url: BASE_URL + "CListas_Disciplinas/read",
                            pager: "pagerCDadosInscricaoTM"
                        }, {
                            view: "pager", id: "pagerCDadosInscricaoTM",
