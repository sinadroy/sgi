...
class CFinancas_Inscricao_Comprovativo extends CI_Controller {
    /*
    ...
    */
    ...
    public function imprimir(){
        ...
        $this->load->model('MFinancas_Inscricao_Comprovativo');
        $this->MFinancas_Inscricao_Comprovativo->criarPdf($id,$total_pagar,$bancNome,$contNumero,$ffpNome,$fpcRefPagamento,$utilizadores_id);
    }
}
