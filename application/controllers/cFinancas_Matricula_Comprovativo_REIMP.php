...
class CFinancas_Matricula_Comprovativo_REIMP extends CI_Controller {
    /*
    ...
    */
    ...
    public function imprimir(){
        ...
        $this->load->model('MFinancas_Matricula_Comprovativo_REIMP');
        $this->MFinancas_Matricula_Comprovativo_REIMP->criarPdf($id,$utilizadores_id);
    }
}
