<?php
  class Ccbrepetido1s extends CI_Controller{
      ...
      public function read(){
        ...
        $this->db->select('Academica_Planificacao_Exame_Candidatos.id,Academica_Planificacao_Exame_Candidatos.Candidatos_id, Academica_Planificacao_Exame_Candidatos.apecCodigoBarra');
        $this->db->from('Academica_Planificacao_Exame_Candidatos');
