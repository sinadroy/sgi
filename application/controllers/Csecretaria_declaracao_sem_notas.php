...
class Csecretaria_declaracao_sem_notas extends CI_Controller {
    public function imprimir(){
        ...
        $this->load->model('Msecretaria_declaracao_sem_notas');
        $this->Msecretaria_declaracao_sem_notas->criarPdf($id,$eid,$cnome,$cnomes,$capelido,$cbi_passaporte,$cBI_Data_Emissao,
