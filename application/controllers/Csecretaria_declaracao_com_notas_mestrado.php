...
class Csecretaria_declaracao_com_notas_mestrado extends CI_Controller {
    public function imprimir(){
        ...
        $this->load->model('Msecretaria_declaracao_com_notas_mestrado');
        $this->Msecretaria_declaracao_com_notas_mestrado->criarPdf($id,$eid,$cnome,$cnomes,$capelido,$cbi_passaporte,$cBI_Data_Emissao,
