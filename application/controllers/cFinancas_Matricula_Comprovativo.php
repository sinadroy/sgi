...
class CFinancas_Matricula_Comprovativo extends CI_Controller {
    /*
    ...
    */
    ...
    public function imprimir(){
       ...
       // $anoLectivoIngresso = $request['anoLectivoIngresso'];
        ...
        $this->MEstudantes->cambiar_estado_matricula($id,"Mat.Aceite");
        
        $this->load->model('MFinancas_Matricula_Comprovativo');
        $this->MFinancas_Matricula_Comprovativo->criarPdf($id,$total_pagar,$bancNome,$contNumero,$ffpNome,$fpcRefPagamento,$utilizadores_id);
    }
}
