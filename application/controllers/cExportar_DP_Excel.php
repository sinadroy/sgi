...
class CExportar_DP_Excel extends CI_Controller {
	...
	public function Exportar(){
        ...
        $kolomhead = 0;
        xlsWriteLabel($tablehead, $kolomhead++, "ORD");
		...
		foreach($this->MCandidatos->mreadto_Excel2() as $row){
            $kolombody = 0;

            //ubah xlsWriteLabel menjadi xlsWriteNumber untuk kolom numeric
            xlsWriteNumber($tablebody, $kolombody++, $row['ord']);
