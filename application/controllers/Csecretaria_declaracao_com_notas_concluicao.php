...
class Csecretaria_declaracao_com_notas_concluicao extends CI_Controller {
    public function imprimir(){
        ...
        $this->load->model('Msecretaria_declaracao_com_notas_concluicao');
        $this->Msecretaria_declaracao_com_notas_concluicao->criarPdf($id,$eid,$cnome,$cnomes,$capelido,$cbi_passaporte,$cBI_Data_Emissao,
