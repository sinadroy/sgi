...
class CFinancas_Inscricao_2S_Comprovativo extends CI_Controller {
    /*
    ...
    */
    ...
    public function imprimir(){
        ...
        $this->load->model('MFinancas_Inscricao_2S_Comprovativo');
        $this->MFinancas_Inscricao_2S_Comprovativo->criarPdf($id,$total_pagar,$bancNome,$contNumero,$ffpNome,$fpcRefPagamento,$utilizadores_id);
    }
}
