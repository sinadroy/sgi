...
<html>
   ...
   <!-- <link rel="stylesheet" href="http://cdn.webix.com/edge/webix.css" type="text/css"> 
    ...
    <body>
        ...
        <!-- SUB-MODULOS -->
        <script src=<?php echo $web_dir."MODULOS/Calendarios/avaliacoes.js";?> type="text/javascript"></script>
       ...
       <script type="text/javascript" charset="utf-8">
        ...
        webix.ui({
            ...
            rows:[	
                {view:"toolbar", cols:[
                    ...
                    {},
                    { view:"label", label:"Calendarios",width:300},
                    {},
		...
		{ 
            cols:[
                { 
                    ...
                    url: BASE_URL+"CSubModulos/read?modulo=13&usuario="+user_sessao,
                    select:true,
                    on:{
        ...
        function open_new_tab(id){
            var item = $$('menuCalendarios').getItem(id);
            //add tab
            if(!$$(item.id)){
                if(item.smCodigo==='1301'){
                    //console.log('entro en 1');
                    cargarVistaAvaliacoes(item.smCodigo);
                }
