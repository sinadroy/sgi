...
<html>
    <head>
        ...
        <link rel="stylesheet" href=<?php echo $web_dir . "resources/css/estiloRedesSociales.css";
?> type="text/css"> 
<!--<<link rel="stylesheet" href=<?php //echo $web_dir."resources/css/font-awesome.min.css";
?> type="text/css"> -->
        <link rel="stylesheet" href=<?php echo $web_dir . "resources/css/style.css";
?> type="text/css">
        <style>
            #areaA, #areaB{
                margin: 50px;
    ...
    <body>
        ...
        <div style="background-color:whitesmoke;">
            ...
            <!--logoGeSoftv1-->
            <div id="headerSpace2" style="background-color:#f1c40f; height:100px;"><img src="resources/images/Logo_Mandavek_Service.png" border="0" height="110" width="210" align="left" /> <!--<img src="resources/images/logoGeSoftTexto.png" border="0" height="50" width="100" align="left" />--></div>
        ...
        <script type="text/javascript" charset="utf-8">
            ...
            var videos = {view: "button", type: "imageButton", label: "Multimedia", image: PRO_URL + "resources/icons/im32x32.png", width: 125, click: function () {
                    var redirect = 'http://172.11.0.11/multimedia';
                    window.location = redirect;
            }};
            webix.ui({
                //type:"clean",
