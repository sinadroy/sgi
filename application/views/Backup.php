...
<html>
   ...
   <!-- <link rel="stylesheet" href="http://cdn.webix.com/edge/webix.css" type="text/css"> 
    ...
    <body>
        ...
        <!-- SUB-MODULOS -->
        <script src=<?php echo $web_dir."MODULOS/Backup/Base_Dados.js";?> type="text/javascript"></script>
       ...
       <script type="text/javascript" charset="utf-8">
        ...
        webix.ui({
            ...
            rows:[	
                {view:"toolbar", cols:[
                    ...
                    {},
                    { view:"label", label:"BACKUP",width:300},
                    {},
		...
		{ cols:[
                    { view:"list", id:"menuBackup",
                        ...
                        url: BASE_URL+"CSubModulos/read?modulo=08&usuario="+user_sessao,
                        select:true,
                        on:{
                    ...
                    rows:[
                        ...
                        { id:"views", cells:[
                            {view:"template", id:"tpl", height:900,template:"Vem-Bindo ao Sub-Sistema de BACKUP."}
                        ]}
                    ]}
                ]}
            ]
        ...
        function open_new_tab(id){
            var item = $$('menuBackup').getItem(id);
            //add tab
            if(!$$(item.id)){
                if(item.smCodigo==='0801'){
                    cargarVistaBase_Dados(item.smCodigo);
                }
