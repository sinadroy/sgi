...
<html>
   ...
   <!-- <link rel="stylesheet" href="http://cdn.webix.com/edge/webix.css" type="text/css"> 
    ...
    <link rel="stylesheet" href=<?php echo $web_dir."webix/codebase/skins/light.css";?> type="text/css" media="screen" charset="utf-8">
    ...
    <body>
        ...
        <!-- SUB-MODULOS -->
        <script src=<?php echo $web_dir."MODULOS/RHumanos/Funcionarios.js";?> type="text/javascript"></script>
       <!-- <script src=<?php //echo $web_dir."MODULOS/RHumanos/Ferias.js";?> type="text/javascript"></script>
        ...
        <script src=<?php echo $web_dir."MODULOS/RHumanos/Licencas.js";?> type="text/javascript"></script>
        <script src=<?php echo $web_dir."MODULOS/RHumanos/Reconhecimentos.js";?> type="text/javascript"></script>
        <script src=<?php echo $web_dir."MODULOS/RHumanos/Sancoes.js";?> type="text/javascript"></script>
        <script src=<?php echo $web_dir."MODULOS/RHumanos/Em_Formacao_Funcionarios.js";?> type="text/javascript"></script>
        <script src=<?php echo $web_dir."MODULOS/RHumanos/Formacao_Funcionarios.js";?> type="text/javascript"></script>
        <script src=<?php echo $web_dir."MODULOS/RHumanos/Publicacoes.js";?> type="text/javascript"></script>
        <script src=<?php echo $web_dir."MODULOS/RHumanos/Eventos.js";?> type="text/javascript"></script>
        <script src=<?php echo $web_dir."MODULOS/RHumanos/Outras_Formacoes.js";?> type="text/javascript"></script>
        <script src=<?php echo $web_dir."MODULOS/RHumanos/Linguas.js";?> type="text/javascript"></script>
        <script src=<?php echo $web_dir."MODULOS/RHumanos/Licenca_Motivos.js";?> type="text/javascript"></script>
       ...
       <script type="text/javascript" charset="utf-8">
        ...
        webix.ui({
            ...
            rows:[	
                {view:"toolbar", cols:[
                    ...
                    {},
                    { view:"label", label:"RECURSOS HUMANOS",width:300},
                    {},
		...
		{ cols:[
			...
			type:{
                        ...
                        url: BASE_URL+"CSubModulos/read?modulo=02&usuario="+user_sessao,
			select:true,
			on:{
                    ...
                    rows:[
                        ...
                        { id:"views", cells:[
                            {view:"template", id:"tpl", height:900,template:"Vem-Bindo ao Sub-Sistema de Recursos Humanos."}
                        ]}
                    ]}
                ]}
            ]
