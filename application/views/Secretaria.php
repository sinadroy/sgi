...
<html>
   ...
   <!-- <link rel="stylesheet" href="http://cdn.webix.com/edge/webix.css" type="text/css"> 
    ...
    <link rel="stylesheet" href=<?php echo $web_dir."webix/codebase/skins/metro.css";?> type="text/css">
    ...
    <body>
        ...
        <!-- SUB-MODULOS -->
        <script src=<?php echo $web_dir."MODULOS/Secretaria/DeclaracaoSemNotas.js";?> type="text/javascript"></script>
       ...
       <script type="text/javascript" charset="utf-8">
        ...
        webix.ui({
            ...
            rows:[	
                {view:"toolbar", cols:[
                    { view:"label", type:"image", label:"Sistema de Gest&atilde;o Integrada",width:300,/*image:PRO_URL+"resources/images/logoGeSoftv1-2.png"*/},
                    {},
                    { view:"label", label:"SECRETARIA",width:300},
                    {},
		...
		{ cols:[
                    { view:"list", id:"menuSecretaria",
                        ...
                        url: BASE_URL+"CSubModulos/read?modulo=12&usuario="+user_sessao,
                        select:true,
                        on:{
        ...
        function open_new_tab(id){
            var item = $$('menuSecretaria').getItem(id);
            //add tab
            if(!$$(item.id)){
                if(item.smCodigo==='1201'){
                    cargarVistaDeclaracaoSemNotas(item.smCodigo);
                }
                if(item.smCodigo==='1202'){
                    cargarVistaDeclaracaoSemNotasMestrado(item.smCodigo);
                }
                if(item.smCodigo==='1203'){
                    cargarVistaDeclaracaoComNotasConcluicao(item.smCodigo);
                }
