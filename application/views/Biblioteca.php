       ...
       <script type="text/javascript" charset="utf-8">
        ...
        webix.ui({
            ...
            rows:[	
                {view:"toolbar", cols:[
                    ...
                    {},
                    { view:"label", label:"BIBLIOTECA",width:300},
                    {},
		...
		{ cols:[
			...
			type:{
                        ...
                        url: BASE_URL+"CSubModulos/read?modulo=07&usuario="+user_sessao,
			select:true,
			on:{
                    ...
                    rows:[
                        ...
                        { id:"views", cells:[
                            {view:"template", id:"tpl", height:900,template:"Vem-Bindo ao Sub-Sistema de Biblioteca."}
                        ]}
                    ]}
                ]}
            ]
        ...
        function open_new_tab(id){
            var item = $$('menuBiblioteca').getItem(id);
            //add tab
            if(!$$(item.id)){
                if(item.smCodigo==='0701'){
