...
<html>
   ...
   <!-- <link rel="stylesheet" href="http://cdn.webix.com/edge/webix.css" type="text/css"> 
    ...
    <link rel="stylesheet" href=<?php echo $web_dir."webix/codebase/skins/aircompact.css";?> type="text/css">
    ...
    <body>
        ...
        <!-- SUB-MODULOS -->
        <script src=<?php echo $web_dir."MODULOS/Presencas/RegimeTemposP.js";?> type="text/javascript"></script>
        <script src=<?php echo $web_dir."MODULOS/Presencas/HorarioAdministrativos.js";?> type="text/javascript"></script>
        <script src=<?php echo $web_dir."MODULOS/Presencas/RegistroFuncionarios.js";?> type="text/javascript"></script>
       ...
       <script type="text/javascript" charset="utf-8">
        ...
        webix.ui({
            ...
            rows:[	
                {view:"toolbar", cols:[
                    ...
                    {},
                    { view:"label", label:"PRESEN&Ccedil;AS",width:300},
                    {},
		...
		{ cols:[
			...
			type:{
                        ...
                        url: BASE_URL+"CSubModulos/read?modulo=04&usuario="+user_sessao,
			select:true,
			on:{
                    ...
                    rows:[
                        ...
                        { id:"views", cells:[
                            {view:"template", id:"tpl", height:900,template:"Vem-Bindo ao Sub-Sistema de Presen&ccedil;as."}
                        ]}
                    ]}
                ]}
            ]
        ...
        function open_new_tab(id){
            var item = $$('menuPresencas').getItem(id);
            //add tab
            if(!$$(item.id)){
                if(item.smCodigo==='0401'){
                    //console.log('entro en 1');
                    cargarVistaRegimeTempos(item.smCodigo);
                }
                if(item.smCodigo==='0402'){
                    cargarVistaHorarioAdministrativos(item.smCodigo);
                }
                //cargarVistaRegistroFuncionarios
                if(item.smCodigo==='0403'){
                    cargarVistaRegistroFuncionarios(item.smCodigo);
                }
