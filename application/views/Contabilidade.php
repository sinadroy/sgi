...
<html>
    <head>
        <title>SGI-Cont</title>
   <!-- <link rel="stylesheet" href="http://cdn.webix.com/edge/webix.css" type="text/css"> 
    <script src="http://cdn.webix.com/edge/webix.js" type="text/javascript"></script> -->
    <link rel="stylesheet" href=<?php echo $web_dir."webix/codebase/skins/light.css";?> type="text/css">
    ...
    <body>
       ...
       <script type="text/javascript" charset="utf-8">
		...
		{ cols:[
                    { view:"list", id:"menuContabilidade",
                        //template:"#smNome#",
			width: 200,
			autoheight:true,
			...
			on:{
                    ...
                    rows:[
                        ...
                        { id:"views", cells:[
                            {view:"template", id:"tpl", height:900,template:"Vem-Bindo ao Sub-Sistema de Contabilidade."}
                        ]}
                    ]}
                ]}
            ]
        ...
        function open_new_tab(id){
            var item = $$('menuContabilidade').getItem(id);
            //add tab
            if(!$$(item.id)){
