...
<html>
   ...
   <!-- <link rel="stylesheet" href="http://cdn.webix.com/edge/webix.css" type="text/css"> 
    ...
    <link rel="stylesheet" href=<?php echo $web_dir."webix/codebase/skins/glamour.css";?> type="text/css">
    ...
    <body>
        ...
        <!-- SUB-MODULOS -->
        <script src=<?php echo $web_dir."MODULOS/Comunicados/Comunicados_Intranet.js";?> type="text/javascript"></script>
       ...
       <script type="text/javascript" charset="utf-8">
        ...
        webix.ui({
            ...
            rows:[	
                {view:"toolbar", cols:[
                    ...
                    {},
                    { view:"label", label:"INTRANET",width:300},
                    {},
		...
		{ cols:[
			...
			type:{
                        ...
                        url: BASE_URL+"CSubModulos/read?modulo=09&usuario="+user_sessao,
			select:true,
			on:{
                    ...
                    rows:[
                        ...
                        { id:"views", cells:[
                            {view:"template", id:"tpl", height:900,template:"Vem-Bindo ao Sub-Sistema de Intranet."}
                        ]}
                    ]}
                ]}
            ]
        ...
        function open_new_tab(id){
            var item = $$('menuIntranet').getItem(id);
            //add tab
            if(!$$(item.id)){
                if(item.smCodigo==='0901'){
                    cargarVistaComunicados_Intranet(item.smCodigo);
                }
