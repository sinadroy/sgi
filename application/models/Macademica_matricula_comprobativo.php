<?php
  class Macademica_matricula_comprobativo extends CI_Model{
    ...
    */
    function registrar_pagamento($fppcCodigoBarra,$Candidatos_id){
        ...
        $Financas_Tipo_Pagamento_id = "4"; //Inscrição
    ...
    public function criarPdf($bi,$codigo_barra,$codigo,$utilizadores_id)
    {
        ...
        $this->MAuditorias_Academicas->minsert("Matricular:Candidato","Academica","Matricula",$utilizadores_id,"Estudante: ".$cNome.' '.$cApelido.' BI: '.$cBI_Passaporte.' Matriculado com sucesso');
            ...
            <page>
                <div align="center">
                    ...
                    <table align="center" border="1">
                        <tr ><td border="0" align="center" width="600"> <h4>Comprovativo de Matr&iacute;cula</h4><br> </td></tr>
                    </table>
                    <br>
                    <table>
                ...
                <div align="center">
                    <table align="center" border="1" cellpadding="0" cellspacing="0">
                        <tr><td  width="100"><b>N&iacute;vel</b></td> <td width="300"><b>Curso</b></td><td width="200"><b>Per&iacute;odo</b></td><td width="100"><b>Pre&ccedil;o Conf.</b></td></tr>
                        '.$listaInscricao.'
                    </table>
                    <br>
                </div>
                ...
                <div align="center">
                    <table align="center" border="1" cellpadding="0" cellspacing="0">
                        <tr><td  width="100"><b>N&iacute;vel</b></td> <td width="300"><b>Curso</b></td><td width="200"><b>Per&iacute;odo</b></td><td width="100"><b>Pre&ccedil;o Insc.</b></td></tr>
                        '.$listaInscricao.'
                    </table>
                    <br>
                </div>
        ...
        $this->hpdf->Output('relatorios/Academica_Matricula_Comprobativo.pdf','F');
        echo "true";
    }       
  }
