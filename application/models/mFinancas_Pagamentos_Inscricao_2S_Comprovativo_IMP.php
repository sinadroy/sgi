<?php
  class MFinancas_Pagamentos_Inscricao_2S_Comprovativo_IMP extends CI_Model{
    ...
    */
    function registrar_pagamento($fppcCodigoBarra,$Candidatos_id){
        ...
        $Financas_Tipo_Pagamento_id = "2"; //Inscrição 2º sessão
    ...
    public function criarPdf($id,$codigo_barra,$codigo,$utilizadores_id)
    {
        ...
        $this->hpdf->Output('relatorios/Financas_Pagamentos_Inscricao_2S_Comprovativo_IMP.pdf','F');
        echo "true";
    }       
  }
