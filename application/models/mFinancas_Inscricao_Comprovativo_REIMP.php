<?php
  class MFinancas_Inscricao_Comprovativo_REIMP extends CI_Model{
...
/*
    ...
    */
    ...
    public function criarPdf($id,$utilizadores_id)
    {
        ...
        $ftpNome = $this->MFinancas_Tipo_Pagamento->mreadXtipo("Inscrição");
        //utilizador id
        ...
        //                                $ftpNome,$ffpNome,$contNumero,$uid);
        ...
        foreach ($this->mread($bi) as $value) {
            ...
            $alAno = $value['alAno'];
            $total_pagar = $total_pagar + $ncPreco_Inscricao;
            //$contador++;
            ...
            <page>
                <div align="center">
                    ...
                    <table align="center" border="1">
                        <tr ><td border="0" align="center" width="600"> <h3>Finan&ccedil;as Comprovativo de Inscri&ccedil;&atilde;o</h3><br> </td></tr>
                    </table>
                    <br>
                    <table>
        ...
        $this->hpdf->Output('relatorios/Financas_Inscricao_Comprovativo_REIMP.pdf','F');
        echo "true";
    }       
  }
