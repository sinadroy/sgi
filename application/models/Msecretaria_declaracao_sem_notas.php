            ...
            <page>
                ...
                <div>
                    <table align="center" border="0">
                        <tr ><td border="0" align="center" width="600"> <p style="font-size: 15pt; font-family: Arial;"><b>Informação Académica N.º '.$incremento.'/'.date('Y').'</b></p> </td></tr>
                    </table>
                </div>
				<br>
                ...
                <div>
                    <p style="font-size: 12pt; font-family: Arial; text-align: justify; line-height: 150%;">
                        ...
                        '.$artigo.' '.$cBI_Lugar_Emissao_Provincia_id.', em '.$cBI_Data_Emissao.'.<br>
						<b>Frequenta o '.$acnome.' Ano do Curso de '.$nnome.' em Ciências de Educação, 
						Opção '.$curso.', período '.$pnome.' no Ano lectivo de 2017</b>.
                    </p>
                </div>
                <br>
                <div>
