<?php
  class MFinancas_Inscricao_2S_Comprovativo_REIMP extends CI_Model{
...
/*
    ...
    */
    ...
    public function criarPdf($id,$total_pagar,$utilizadores_id)
    {
        ...
        //$this->registrar_pagamento_inscricao($Candidatos_id,"",$data,$fpcHora,$total_pagar,$fpcRefPagamento,$ftpNome,$ffpNome,$contNumero,$uid,$utilizadores_id);
        ...
        $this->hpdf->Output('relatorios/Financas_Inscricao_2S_Comprovativo_REIMP.pdf','F');
        echo "true";
    }       
  }
