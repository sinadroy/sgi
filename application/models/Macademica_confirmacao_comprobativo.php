<?php
  class Macademica_confirmacao_comprobativo extends CI_Model{
    ...
    */
    ...
    public function criarPdf($bi,$codigo_barra,$codigo,$utilizadores_id)
    {
        ...
        foreach ($this->mread($bi) as $value) {
            ...
            $curso = $value['curso'];
            $pNome = $value['pNome'];
            $ncPreco_Confirmacao = $value['ncPreco_Confirmacao'];
            ...
            <page>
                <div align="center">
                    ...
                    <table align="center" border="1">
                        <tr ><td border="0" align="center" width="600"> <h4>Comprovativo de Confirma&ccedil;&atilde;o de Matr&iacute;cula</h4><br> </td></tr>
                    </table>
                    <br>
                    <table>
