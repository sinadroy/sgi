<?php
  class MFinancas_Matricula_Comprovativo extends CI_Model{
...
/*
    ...
    */
    function registrar_pagamento_matricula($Candidatos_id,$fpcCodigoBarra,$fpcData,$fpcHora,$fpcValor,$fpcRefPagamento,
                                                        $ftpNome,$ffpNome,$contNumero,$uid,$utilizadores_id){
        $this->load->model('MFinancas_Pagamentos_Candidatos');
        if($this->MFinancas_Pagamentos_Candidatos->minsert_matricula($Candidatos_id,$fpcCodigoBarra,$fpcData,$fpcHora,$fpcValor,$fpcRefPagamento,
                                                        $ftpNome,$ffpNome,$contNumero,$uid,$utilizadores_id))
            return true;
        else
            return false;
    ...
    public function criarPdf($id,$total_pagar,$bancNome,$contNumero,$ffpNome,$fpcRefPagamento,$utilizadores_id)
    {
        ...
        $ftpNome = $this->MFinancas_Tipo_Pagamento->mreadXtipo("Matrícula");
        //utilizador id
        $this->load->model('mutilizadores');
        $uid = $this->mutilizadores->mreadXnome($utilizadores_id);
        $this->registrar_pagamento_matricula($Candidatos_id,"",$data,$fpcHora,$total_pagar,$fpcRefPagamento,
                                        $ftpNome,$ffpNome,$contNumero,$uid,$utilizadores_id);
            ...
            <page>
                <div align="center">
                    ...
                    <table align="center" border="1">
                        <tr ><td border="0" align="center" width="600"> <h4>Finan&ccedil;as Comprovativo de Matr&iacute;cula</h4><br> </td></tr>
                    </table>
                    <br>
                    <table>
        ...
        $this->hpdf->Output('relatorios/Financas_Matricula_Comprovativo.pdf','F');
        echo "true";
    }       
  }
