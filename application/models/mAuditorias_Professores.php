<?php
  class MAuditorias_Professores extends CI_Model{
      ...
      function mread($i, $l){
          ...
          $this->db->where('audModulo',"Professores");
      ...
      function mread_search($i, $l, $x){
        $this->db->select('id,audOperacao,audData,audHora,audDescricao,audUsuario, audModulo, audSubModulo');
        $this->db->from('Auditorias');
        $this->db->where('audModulo',"Professores");
        
        $this->db->like('audOperacao',$x);
        $this->db->or_like('audData',$x);
        $this->db->or_like('audHora',$x);
        $this->db->or_like('audDescricao',$x);
        $this->db->or_like('audUsuario',$x);
        $this->db->order_by('audSubModulo',$x);
