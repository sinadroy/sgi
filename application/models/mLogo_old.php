<?php
  class MLogo extends CI_Model{
    ...
    var $logo_Documentos_titulo = "INSTITUTO SUPERIOR DE CI&Ecirc;CIAS DE EDUCA&Ccedil;&Atilde;O DO HUAMBO"; //titulo debajo del logotipo de los docs SIEMPRE MAYUSCULA
