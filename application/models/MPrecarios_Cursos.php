<?php
  class MPrecarios_Cursos extends CI_Model{
    ...
    public function mexiste($nid,$cid,$pid,$precid){
    ...
    function mupdate($id,$n,$c,$p,$prec,$ncp_preco,$ncp_precou){
        $this->load->model('MNiveisCursos');
        $ncp_id = $this->MNiveisCursos->mreadXncp($n,$c,$p);
        $d = array('niveis_cursos_id' => $ncp_id, 'precario_id' => $prec, 'ncp_preco' => $ncp_preco, 'ncp_precou' => $ncp_precou);
    ...
    function minsert($n,$c,$p,$prec,$ncp_preco,$ncp_precou){
        $this->load->model('MNiveisCursos');
        $ncp_id = $this->MNiveisCursos->mreadXncp($n,$c,$p);
        $d = array('niveis_cursos_id' => $ncp_id, 'precario_id' => $prec, 'ncp_preco' => $ncp_preco, 'ncp_precou' => $ncp_precou);
