<?php
  class MFinancas_Confirmacao_Comprovativo extends CI_Model{
...
/*
    ...
    */
    function registrar_pagamento_confirmacao($Candidatos_id,$fpcCodigoBarra,$fpcData,$fpcHora,$fpcValor,$fpcRefPagamento,
                                                        $ftpNome,$ffpNome,$contNumero,$uid,$utilizadores_id){
        $this->load->model('MFinancas_Pagamentos_Candidatos');
        if($this->MFinancas_Pagamentos_Candidatos->minsert_confirmacao($Candidatos_id,$fpcCodigoBarra,$fpcData,$fpcHora,$fpcValor,$fpcRefPagamento,
                                                        $ftpNome,$ffpNome,$contNumero,$uid,$utilizadores_id))
            return true;
        else
            return false;
    ...
    public function criarPdf($id,$total_pagar,$bancNome,$contNumero,$ffpNome,$fpcRefPagamento,$utilizadores_id)
    {
        ...
        $this->registrar_pagamento_confirmacao($Candidatos_id,"",$data,$fpcHora,$total_pagar,$fpcRefPagamento,
                                        $ftpNome,$ffpNome,$contNumero,$uid,$utilizadores_id);
