<?php
  class MFinancas_Confirmacao_Comprovativo_REIMP extends CI_Model{
    ...
    */
    ...
    public function criarPdf($id,$utilizadores_id)
    {
        ...
        foreach ($this->mread($bi) as $value) {
            ...
            $total_pagar = /*$total_pagar +*/ $ncPreco_Confirmacao;
            //$contador++;
        ...
        $this->hpdf->Output('relatorios/Financas_Confirmacao_Comprovativo_REIMP.pdf','F');
        echo "true";
    }       
  }
