<?php
  class MAcademica_Candidatos_Codigo_Barra_IMP extends CI_Model{
	...
	//	ini_set('max_execution_time', '300'); 
                ...
                <page>
                    <div align="center">
                        ...
                        <table align="center" border="1">
                            <tr ><td border="0" align="center" width="600"> <h4>Exame de Acesso: C&oacute;digo de Barra</h4><br> </td></tr>
                        </table>
                        <br>
                        <br>
        ...
        $content = '
            <page>
                <div align="center">
                    <img src='.APPPATH.'../resources/images/logoGeSoftv1.png border="0" height="60" width="60"/><br><br>
                    <b>INSTITUTO SUPERIOR X</b><br>
                    <br>
        ...
        */
        ...
        $this->hpdf->Output('relatorios/Academica_Candidatos_Codigo_Barra_IMP.pdf','F');
        echo "true";
    }       
  }
