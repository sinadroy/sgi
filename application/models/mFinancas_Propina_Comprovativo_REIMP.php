<?php
  class MFinancas_Propina_Comprovativo_REIMP extends CI_Model{
...
/*
    ...
    */
    ...
    public function criarPdf($id,$ano_lectivo,$utilizadores_id,$mesNome, $bi, $mes_a_pagar, $ano_a_pagar)
    {
        ...
        //obtener total a pagar em propinas por curso
        $this->load->model('Mpagamentos_propina');
        $valor_propina = $this->Mpagamentos_propina->mreadXvalor_propina($bi, $mes_a_pagar, $ano_a_pagar);
        ...
        $multica = $valor_propina - $ncPreco_Propina;
        $content = '
            <page>
                <div align="center">
                ...
                <div align="center">
                    <table align="center" border="0.5" cellpadding="0" cellspacing="0">
                        ...
                        <tr><td  width="100"><b></b></td> <td width="350"><b></b></td><td width="100"><b>Total:</b></td><td width="150"><b>'.$valor_propina.'</b></td></tr>
                    </table>
                    <br>
                </div>
        ...
        $this->hpdf->Output('relatorios/Financas_Propina_Comprovativo_Reimp.pdf','F');
        echo "true";
    }       
  }
