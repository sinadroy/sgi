            ...
            <page>
                ...
                <div>
                    <table align="center" border="0">
                        <tr ><td border="0" align="center" width="600"> <p style="font-size: 15pt; font-family: Arial;"><b>Informação Académica N.º '.$id.'/'.date('Y').'</b></p> </td></tr>
                    </table>
                </div>
				<br>
                <div align="left" width="400">
                    <table align="left" border="0" cellpadding="0" cellspacing="0">
                        <tr><td  width="400"><p align="center" style="font-size: 10pt; font-family: Arial;">Visto <br> Director Geral Adjunto para Área Académica <br><br> <b>Afonso Vindassi Manuel</b></p></td></tr>
                    </table>
                </div>
				<br>
                ...
                <div>
                    <p style="font-size: 12pt; font-family: Arial; text-align: justify; line-height: 150%;">
                        ...
                        Instituto Superior de Ciências de Educação do Huambo. <br>Declaro em 
                        ...
                        '.$nnome.' em Ciências de Educação, Opção '.$curso.', período '.$pnome.' no Ano lectivo de '.date('Y').'.
                    </p>
                </div>
                <br>
                <div>
